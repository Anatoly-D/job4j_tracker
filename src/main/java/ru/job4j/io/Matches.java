...
public class Matches {
    public static void main(String[] args) {
        ...
        while (matchQty > 0) {
            System.out.println("На столе " + matchQty + " спичек, игрок " + (currentUser % gamesQty + 1) + " возьмите от 1 до 3 спичек:");
        ...
        System.out.println("Ура, игрок " + currentUser % gamesQty + " выиграл!");
    }
